...
struct  ArquitecturaView: View {
    @EnvironmentObject var languageManager: LanguageManager // Importamos el languageManager
    var body: some View {
        ZStack{
            Color(red: 190/255, green: 0/255, blue: 0/255)                .edgesIgnoringSafeArea(/*@START_MENU_TOKEN@*/.all/*@END_MENU_TOKEN@*/)
...
#Preview {
    ArquitecturaView().environmentObject(LanguageManager())
}
